...
class AtmDb{
    ...
    public AtmDb(int balance, int deposit, int withdrawal) {
        this.bal = balance;
...
class CustDb {
    ...
    public CustDb(String accountNumber, String customerName, String pinNumber, int accountBalance) {
    ...
    public void withdraw(String accountNumber, int amount, TreeMap<String, CustDb> db){
         db.get(accountNumber).setAccountBalance(getAccountBalance()-amount);
    }

    public void deposit(String accountNumber, int amount, TreeMap<String, CustDb> db){
        db.get(accountNumber).setAccountBalance(getAccountBalance()+amount);
    }
}
class HandleAtm {
...
class HandleCustomer {
    ...
    public boolean validAccountNumber(String accountNumber, TreeMap<String, CustDb> db){
        if(accountNumber.equals(db.get(accountNumber).getAccountNumber())){
            return true;
        }
        return false;
    }
    public boolean validPinNumber(String accountNumber, String pinNumber, TreeMap<String, CustDb> db){
    ...
    public void transferAmount(String fromAccountNumber, String toAccountNumber, int amount, TreeMap<String, CustDb> db){
...
public class AtmTask {
    public static void main(String[] args) {
        try(Scanner scanner=new Scanner(System.in);) {
            ...
            while (true){
                int option=0;
                System.out.println("HI!select the services you need\n1.TO Load ATM\n2. Withdraw From ATM\n3. Check ATM Balance\n4. Create Account\n5. Transfer\n6. Check Account Balance\n7. Display All Customer Details\n8. Deposit\n9. End");
                ...
                switch (option){
                    case 1:
                    {
                        ...
                        for(String seperate:denominations){
                            ...
                            if(amount<0||denomination<0){
                                System.out.println("your deposited amount is wrong");
                            }
                            else if (amount==0||denomination==0){
                                System.out.println("your deposited amount is zero");
                            }
                            else{
                    ...
                    case 4:
                    {
                        ...
                        if(acoountBalance>=500){
                            CustDb customerDatabase=new CustDb(accountNumber,customerName, pinNumber, acoountBalance);
